 ...
 * FileType
 */
class LinkedFileType extends NumericType
{
	/**
	 * Constructor
	 * @param name
	 ...
	 */
	function LinkedFileType( $name, $label, $unsigned_lenght = 10, $signed_lenght = 10, $min_unsigned = 0, $max_unsigned = 4294967295, $min_signed = -2147483648, $max_signed = 2147483647 )
	{
